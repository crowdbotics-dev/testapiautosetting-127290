...
## Project Structure
    ...
    ├── testapiautosetting_127290  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127290`
...
2. Clone this repo and `cd testapiautosetting_127290`
